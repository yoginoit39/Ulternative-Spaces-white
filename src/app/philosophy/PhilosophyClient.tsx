    ...
    >
      ...
      <div
        style={{
          ...
          height: 600,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(var(--fg-rgb),0.06) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
    ...
    >
      ...
      <div
        style={{
          ...
          right: '5vw',
          height: 1,
          background: 'linear-gradient(90deg, transparent, rgba(var(--fg-rgb),0.3), transparent)',
        }}
      />
  ...
  return (
    ...
    >
      ...
      <div style={{
        width: '100%',
        height: 1,
        background: 'linear-gradient(90deg, rgba(var(--fg-rgb),0.3), transparent)',
        marginBottom: 80,
      }} />
    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          height: 28,
          borderRadius: '50%',
          border: '1.5px solid rgba(var(--fg-rgb),0.4)',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          backgroundColor: hovered ? 'rgba(var(--fg-rgb),0.08)' : 'transparent',
          transition: 'background-color 0.3s ease',
          flexShrink: 0,
        }}>
          <div style={{
